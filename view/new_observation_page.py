...
class NewObservation:
    ...
    def show_page(self):
        ...
        self.user_entry = Input(self.frame, 1, 30, has_width=30, default_text="User")
        ...
        self.observation_label_entry = Input(self.frame, 1, 30, has_width=30, default_text="Label")
        ...
        self.observation_description_entry = Input(self.frame, 1, 200, has_width=100, default_text="Description")

        # Session input
        session_label = ttk.Label(self.frame, text="Session")
        session_label.pack()
        self.session_entry = Input(self.frame, 1, 30, has_width=100, default_text="Session")

        # Participant input
        participant_label = ttk.Label(self.frame, text="Participant")
        participant_label.pack()
        self.participant_entry = Input(self.frame, 1, 30, has_width=70, default_text="Participant")
